...
/*! \file gmOpenGL_GLMatrix.c
 *  \brief Inline GLMatrix class implementations
 *
 *  Implementation of the gmOpengGL components GLMatrix class.
 *
 *  \date   2008-08-03
 */
...
namespace GMlib {
  ...
  void GLMatrix::invertOrtho() {
    ...
    swap( _matrix[1], _matrix[4] );
    swap( _matrix[2], _matrix[8] );
    swap( _matrix[6], _matrix[9] );
  ...
  void GLMatrix::_makeOrtho(const UnitVector<float,3>& d, Vector3D<float>& x, Vector3D<float>& y, Vector3D<float>& z) {
    ...
    double d0=fabs(d(0)),d1=fabs(d(1)),d2=fabs(d(2));
    if (d0 > d1)
    {
  ...
  ostream& GLMatrix::_printOut( ostream& out ) const {
    ...
    cout << _matrix[0] << "  " << _matrix[4] << "  " << _matrix[8] << "  " << _matrix[12] << "\n";
    cout << _matrix[1] << "  " << _matrix[5] << "  " << _matrix[9] << "  " << _matrix[13] << "\n";
    cout << _matrix[2] << "  " << _matrix[6] << "  " << _matrix[10]<< "  " << _matrix[14] << "\n";
    cout << _matrix[3] << "  " << _matrix[7] << "  " << _matrix[11]<< "  " << _matrix[15] << "\n";
    return out;
  }
