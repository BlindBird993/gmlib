...
namespace GMlib {
  ...
  inline
  void GM_Static_P_<T,n,m>::mv_xq(T *a, T* b, const Point<T,m>& c) {
    (*a) = GM_Static_<T,m>::dpr(b,c.ptr()); GM_Static_P_<T,n-1,m>::mv_xq(a+1,b+m+1,c);
  }
  ...
  inline
  void GM_Static_P_<T,n,m>::mv_xqP(T *a, T* b, const Point<T,m>& c, T* d) {
    (*a) = GM_Static_<T,m>::dpr(b,c.ptr())+(*d); GM_Static_P_<T,n-1,m>::mv_xqP(a+1,b+m+1,c,d+m+1);
  }
  ...
  inline
  void GM_Static_P_<T,n,m>::vv_ox(Point<T,m> *a, const Point<T,m> *b, T *c) {
    GM_Static_<T,m>::sc_r(a->ptr(),b->ptr(),double(*c)); GM_Static_P_<T,n-1,m>::vv_ox(a+1,b,c+1);
  }
  ...
  inline
  void GM_Static_P_<T,n,m>::sc(Point<T,m>* a, T *b) {
    GM_Static_<T,m>::sc(a->ptr(),(double)*b); return GM_Static_P_<T,n-1,m>::sc(a+1,b+1);
  }
  ...
  inline
  void GM_Static_P_<T,n,m>::hq_2x(T *a, T* b, const Point<T,m>& c) {
    (*a) = GM_Static_<T,m>::dpr(b,c.ptr()); GM_Static_P_<T,n-1,m>::hq_2x(a+1,b+m+1,c);
  }
  ...
  inline
  void GM_Static_P_<T,n,m>::hq_3x(T *a, T* b, const Vector<T,m>& r, T* p) {
    (*a) = (*p) - GM_Static3_<T,m,m>::dpr(r.ptr(),b); GM_Static_P_<T,n-1,m>::hq_3x(a+m+1,b+1,r,p+1);
  }
  ...
  inline
  void GM_Static_P_<T,1,m>::mv_xqP(T *a, T* b, const Point<T,m>& c, T* d) {
    (*a) = GM_Static_<T,m>::dpr(b,c.ptr())+(*d);
  }
  ...
  inline
  void GM_Static_P_<T,1,m>::vv_ox(Point<T,m> *a, const Point<T,m> *b, T *c) {
    GM_Static_<T,m>::sc_r(a->ptr(),b->ptr(),double(*c));
  }
  ...
  inline
  void GM_Static_P_<T,1,m>::sc(Point<T,m>* a, T *b) {
    GM_Static_<T,m>::sc(a->ptr(),(double)*b);
  }
  ...
  inline
  void GM_Static_P_<T,1,m>::hq_3x(T *a, T* b, const Vector<T,m>& r, T* p) {
    (*a) = (*p) - GM_Static3_<T,m,m>::dpr(r.ptr(),b);
  }
