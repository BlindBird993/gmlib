...
namespace GMlib {
  ...
  template <typename T>
  void PEnnepersSurface<T>::eval(T u, T v, int d1, int d2, bool /*lu*/, bool /*lv*/ ) {
  ...
  template <typename T>
  inline
  T PEnnepersSurface<T>::getStartPU() {
  ...
  template <typename T>
  inline
  T PEnnepersSurface<T>::getStartPV() {
