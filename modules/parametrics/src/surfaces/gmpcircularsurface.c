...
namespace GMlib {
  ...
  template <typename T>
  inline
  void PCircularSurface<T>::eval(T u, T v, int d1, int d2, bool /*lu*/, bool /*lv*/ ) {
  ...
  template <typename T>
  inline
  T PCircularSurface<T>::getStartPU() {
  ...
  template <typename T>
  inline
  T PCircularSurface<T>::getStartPV() {
