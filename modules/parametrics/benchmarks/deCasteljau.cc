...
Vector<float,3> cornerCutting(DVector<Vector<float,3>> q, DVector<float> b)
{
    Vector<float,3> final = Vector<float,3>(0,0,0);
...
Vector<float,3> DeCasteljau(int d, DVector<Vector<float,3>> p, DVector<float> b, int n)
{
